...
- 取离线 MITRE ATT&CK Enterprise CTI（STIX 2.1｜attack-stix-data｜固定路径：`backend/app/services/ttp_similarity/cti/enterprise-attack.json`）数据包中的 Intrusion Set → technique 集合，生成每个组织的向量 `V_i`
