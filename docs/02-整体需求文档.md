...
- 已知组织的 technique 集合来自 **离线 MITRE ATT&CK Enterprise CTI（STIX 2.1｜attack-stix-data｜固定路径：`backend/app/services/ttp_similarity/cti/enterprise-attack.json`）** 数据包（随项目交付），不依赖联网查询。
