...
# ========== Phase B weighting / filtering ==========

BASE_RISK_WEIGHTS: Dict[str, float] = {
    RelType.SPAWNED.value: 5.0,
    RelType.CONNECTED.value: 4.0,
    RelType.LOGON.value: 3.0,
    RelType.ACCESSED.value: 2.0,
    RelType.RESOLVES_TO.value: 1.0,
