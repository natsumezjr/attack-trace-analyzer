...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "min-h-screen px-4 py-4 hidden md:flex md:flex-col bg-sidebar text-sidebar-foreground w-[300px] flex-shrink-0 border-r border-sidebar-border",
        className
      )}
      animate={{
  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="text-sidebar-foreground/80 text-base group-hover/sidebar:text-sidebar-foreground group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0"
      >
        {link.label}
      </motion.span>
    </Link>
