  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="text-sidebar-foreground/80 text-sm group-hover/sidebar:text-sidebar-foreground group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0"
      >
        {link.label}
      </motion.span>
    </Link>
