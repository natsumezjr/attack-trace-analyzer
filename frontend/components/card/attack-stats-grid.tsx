...
import { AlertTriangle, Crosshair, ShieldAlert, Network } from "lucide-react";
...
export function AttackStatsGrid() {
  ...
  const onlineTargetsValue =
    targetsLen === undefined ? "--" : targetsLen.toString();

  const stats = [
    {
      label: "在线靶机",
      value: onlineTargetsValue,
      icon: ShieldAlert,
