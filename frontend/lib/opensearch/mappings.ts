...
// Raw Findings索引映射
export const rawFindingsMapping = {
  properties: {
    '@timestamp': { type: 'date' },
    'ecs.version': { type: 'keyword' },
    'event.id': { type: 'keyword' },
...
export const canonicalFindingsMapping = {
  properties: {
    '@timestamp': { type: 'date' },
    'ecs.version': { type: 'keyword' },
    'event.id': { type: 'keyword' },
...
// Attack Chains索引映射
export const attackChainsMapping = {
  properties: {
    '@timestamp': { type: 'date' },
...
// Client Registry索引映射
export const clientRegistryMapping = {
  properties: {
    '@timestamp': { type: 'date' },
